    ...
    <>
      ...
      <ActionBox
        ...
        onButtonClick={() => {
          ...
          window.open('https://paypal.me/werbesiegtpaul/', '_blank');
        }}
      />
      {!newsletter && (
        <ActionBox
...
const styles = {
  ...
  htq: {
    backgroundImage: 'linear-gradient(#460385 0%, #2a024f 100%)',
  },
  jwz: {
    backgroundImage: 'linear-gradient(#1a33c3 0%, #162793 100%)',
  },
  cocktailCoupon: {
