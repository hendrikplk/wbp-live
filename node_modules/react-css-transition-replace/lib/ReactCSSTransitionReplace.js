...
var reactCSSTransitionReplaceChild = _react.default.createFactory(_ReactCSSTransitionReplaceChild.default);

var ReactCSSTransitionReplace =
/*#__PURE__*/
function (_React$Component) {
  ...
  function ReactCSSTransitionReplace(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactCSSTransitionReplace).call(this, props));
  ...
  _createClass(ReactCSSTransitionReplace, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      if (currentChild) {
        ...
        nextState.prevChildren = _objectSpread({}, prevChildren, _defineProperty({}, currentKey, currentChild));
    ...
    value: function render() {
      ...
      Object.keys(prevChildren).forEach(function (key) {
        ...
        childrenToRender.push(_react.default.createElement(childComponent, {
          key: key,
          style: positionAbsolute
        }, _this2.wrapChild(notifyLeaving && typeof child.type !== 'string' ? _react.default.cloneElement(child, {
          isLeaving: true
        }) : child, {
          ref: function ref(r) {
      ...
      return _react.default.createElement(component, containerProps, childrenToRender);
    }
  }]);
