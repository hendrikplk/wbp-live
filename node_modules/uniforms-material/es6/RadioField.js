...
const Radio = (_a) => {
    ...
    disabled, id, inputRef, label, name, onChange, transform, value } = _a, props = __rest(_a, ["allowedValues", "checkboxes", "disabled", "id", "inputRef", "label", "name", "onChange", "transform", "value"]);
