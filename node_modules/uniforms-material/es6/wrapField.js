...
function wrap({ component, disabled, error, errorMessage, fullWidth, helperText, margin, required, showInlineError, variant, }, ...children) {
    ...
    return React.createElement(FormControl, props, ...children, !!formHelperText && React.createElement(FormHelperText, null, formHelperText));
}
