...
const Bool = (_a) => {
    var { appearance, disabled, inputRef, label, legend, name, onChange, transform, value } = _a, props = __rest(_a, ["appearance", "disabled", "inputRef", "label", "legend", "name", "onChange", "transform", "value"]);
    ...
    return wrapField(Object.assign(Object.assign({}, props), { component: 'fieldset', disabled }), legend && (React.createElement(FormLabel, { component: "legend", htmlFor: name }, legend)), React.createElement(FormGroup, null,
