...
var Nest = function (_a) {
    ...
    return wrapField_1.default(tslib_1.__assign(tslib_1.__assign({}, props), { component: undefined }), label && react_1.default.createElement(FormLabel_1.default, { component: "legend" }, label), children
