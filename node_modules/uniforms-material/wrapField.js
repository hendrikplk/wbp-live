...
function wrap(_a) {
    ...
    return react_1.default.createElement.apply(react_1.default, tslib_1.__spreadArrays([FormControl_1.default,
        props], children, [!!formHelperText && react_1.default.createElement(FormHelperText_1.default, null, formHelperText)]));
}
