...
var renderSelect = function (_a) {
    ...
    return (react_1.default.createElement(TextField_1.default, { disabled: !!disabled, error: !!error, fullWidth: fullWidth, helperText: (error && showInlineError && errorMessage) || helperText, InputLabelProps: tslib_1.__assign(tslib_1.__assign({ shrink: !!label && (hasPlaceholder || hasValue) }, labelProps), InputLabelProps), label: label, margin: margin, onChange: function (event) {
            return disabled ||
