...
var Date = function (_a) {
    ...
    return (react_1.default.createElement(TextField_1.default, tslib_1.__assign({ disabled: !!disabled, error: !!error, helperText: (error && showInlineError && errorMessage) || helperText, label: label, InputLabelProps: tslib_1.__assign(tslib_1.__assign({}, labelProps), InputLabelProps), name: name, onChange: function (event) {
